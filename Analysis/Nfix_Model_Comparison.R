...
####
#Read the data in from "SNF_Temp" folder
####
...
fit_Nase_peak.ar_all <- mle2(Nase_peak.ar_normNLL_all,start=list(sdNase=-1,k25M21a=1,k25M21b=1,k25M21c=1,k25M26a=1,k25M26b=1,k25M26c=1,k25M31a=1,k25M31b=1,k25M31c=1,
