...
#Gliricidia sepium
GLSE21a <- read.csv("GLSE21a_Vmax_temp_linKm.csv")
GLSE21b <- read.csv("GLSE21b_Vmax_temp_linKm.csv")
GLSE21c <- read.csv("GLSE21c_Vmax_temp_linKm.csv")
GLSE26a <- read.csv("GLSE26a_Vmax_temp_linKm.csv")
GLSE26b <- read.csv("GLSE26b_Vmax_temp_linKm.csv")
GLSE26c <- read.csv("GLSE26c_Vmax_temp_linKm.csv")
GLSE31a <- read.csv("GLSE31a_Vmax_temp_linKm.csv")
GLSE31b <- read.csv("GLSE31b_Vmax_temp_linKm.csv")
GLSE31c <- read.csv("GLSE31c_Vmax_temp_linKm.csv")

#Morella cerifera
MOCE21a <- read.csv("MOCE21a_Vmax_temp_linKm.csv")
MOCE21b <- read.csv("MOCE21b_Vmax_temp_linKm.csv")
MOCE21c <- read.csv("MOCE21c_Vmax_temp_linKm.csv")
MOCE26a <- read.csv("MOCE26a_Vmax_temp_linKm.csv")
MOCE26b <- read.csv("MOCE26b_Vmax_temp_linKm.csv")
MOCE26c <- read.csv("MOCE26c_Vmax_temp_linKm.csv")
MOCE31a <- read.csv("MOCE31a_Vmax_temp_linKm.csv")
MOCE31b <- read.csv("MOCE31b_Vmax_temp_linKm.csv")
MOCE31c <- read.csv("MOCE31c_Vmax_temp_linKm.csv")

#Robinia pseudoacacia
ROPS21a <- read.csv("ROPS21a_Vmax_temp_linKm.csv")
ROPS21b <- read.csv("ROPS21b_Vmax_temp_linKm.csv")
ROPS21c <- read.csv("ROPS21c_Vmax_temp_linKm.csv")
ROPS26a <- read.csv("ROPS26a_Vmax_temp_linKm.csv")
ROPS26b <- read.csv("ROPS26b_Vmax_temp_linKm.csv")
ROPS26c <- read.csv("ROPS26c_Vmax_temp_linKm.csv")
ROPS31a <- read.csv("ROPS31a_Vmax_temp_linKm.csv")
ROPS31b <- read.csv("ROPS31b_Vmax_temp_linKm.csv")
ROPS31c <- read.csv("ROPS31c_Vmax_temp_linKm.csv")
...
title(main=expression('   '*italic(T)[opt]*' = 31.5 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=31.45,lty=2,col="dodgerblue1")
...
title(main=expression('   '*italic(T)[opt]*' = 32.6 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=32.60,lty=2,col="dodgerblue1")
...
title(main=expression('   '*italic(T)[opt]*' = 33.0 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=33.01,lty=2,col="dodgerblue1")
...
title(main=expression('   '*italic(T)[opt]*' = 34.6 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=34.62,lty=2,col="gold1")
...
title(main=expression('   '*italic(T)[opt]*' = 34.2 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=34.21,lty=2,col="gold1")
...
title(main=expression('   '*italic(T)[opt]*' = 33.0 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=33.01,lty=2,col="gold1")
...
title(main=expression('   '*italic(T)[opt]*' = 37.8 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=37.78,lty=2,col="orangered3")
...
title(main=expression('   '*italic(T)[opt]*' = 35.8 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=35.82,lty=2,col="orangered3")
...
title(main=expression('   '*italic(T)[opt]*' = 33.0 '*degree*'C'),cex.main=1,adj=0,line=-3)
abline(v=33.01,lty=2,col="orangered3")
...
polygon(x=c(Tg.seq,rev(Tg.seq)),y=c(low.rTopt.A275,rev(high.rTopt.A275)),
        col=adjustcolor("dodgerblue3",alpha.f = 0.2),border=NA)
abline(a=ft.m_linKm[13],b=ft.m_linKm[14],col="darkorange1",lwd=1)
abline(a=ft.a[13],b=ft.a[14],col="darkturquoise",lwd=1)
abline(a=ft.g_linKm[14],b=ft.g_linKm[15],col="orangered2",lwd=1)
abline(a=ft.r_linKm[11],b=0,col="dodgerblue3",lwd=1)
...
points(ft.m_linKm[13]+ft.m_linKm[14]*c(18.5,23.5,28.5)~c(18.5,23.5,28.5),pch=16,col="darkorange1",cex=1.5,lwd=1)
points(ft.a[13]+ft.a[14]*c(18.5,23.5,28.5)~c(18.5,23.5,28.5),pch=16,col="darkturquoise",cex=1.5,lwd=1)
points(ft.g_linKm[14]+ft.g_linKm[15]*c(18.5,23.5,28.5)~c(18.5,23.5,28.5),pch=17,col="orangered2",cex=1.5,lwd=1)
points(ft.r_linKm[11]+0*c(18.5,23.5,28.5)~c(18.5,23.5,28.5),pch=17,col="dodgerblue3",cex=1.5,lwd=1)
